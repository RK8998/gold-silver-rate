		...
		<div class="row">
			<div class="col-md-8">
				...
				<div class="comparision_box">
					<div class="row">
						<div class="col-md-12">
							<h4>Comparision Gold-Rate Between 2 cities</h4>
						</div>
					</div>
					<form method="post">
					<div class="row">
						...
						<div class="col-md-5">
							...
							<?php 
								...
								if($ch1_24 < 0){
									echo "
										<h5 style='color:red'>
										<i class='fa-solid fa-angle-down'></i>&nbsp;&nbsp;₹".$pr1_24."</h5>
									";
									echo "
										<p class='mt-2' style='color:red;'>".$ch1_24."</p>
									";
								}
								if($ch1_24 > 0){
									echo "
										<h5 style='color:green;'>
										<i class='fa-solid fa-angle-up'></i>&nbsp;&nbsp;₹".$pr1_24."</h5>
									";
									echo "
										<p class='mt-2' style='color:green;'>".$ch1_24."</p>
									";
								}
							?>
						</div>
						<div class="col-md-5">
							...
							<?php 
								...
								if($ch2_24 < 0){
									echo "
										<h5 style='color:red'>
										<i class='fa-solid fa-angle-down'></i>&nbsp;&nbsp;₹".$pr2_24."</h5>
									";
									echo "
										<p class='mt-2' style='color:red;'>".$ch2_24."</p>
									";
								}
								if($ch2_24 > 0){
									echo "
										<h5 style='color:green;'>
										<i class='fa-solid fa-angle-up'></i>&nbsp;&nbsp;₹".$pr2_24."</h5>
									";
									echo "
										<p class='mt-2' style='color:green;'>".$ch2_24."</p>
									";
								}
							?>
						</div>
